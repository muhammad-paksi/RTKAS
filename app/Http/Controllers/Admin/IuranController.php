...
class IuranController extends Controller
{
    ...
    {
        $breadcrumb = (object)[
            'judul' => 'Admin / Data Iuran',
            'list' => '/ Insert Iuran'
        ];

        return view('admin.manage.insertIuran', compact('breadcrumb'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('viewIuran')->with('success', 'Iuran telah ditambahkan');
    }
    ...
    public function edit(int $id_iuran)
    {
        ...
        return view('admin.manage.editIuran', compact('iuran', 'breadcrumb'));
    }
    /**
    ...
    public function update(Request $request, int $id_iuran)
    {
        ...
        return redirect()->route('viewIuran')->with('success', 'Iuran telah diupdate');
    }
