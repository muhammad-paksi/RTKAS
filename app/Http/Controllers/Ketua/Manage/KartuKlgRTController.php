...
class KartuKlgRTController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('ketua.manage.kk.insertKk', compact('breadcrumb'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ketua.kartukeluarga')->with('success', 'Kartu Keluarga Telah Ditambahkan');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('ketua.manage.show', compact('kartukeluarga'));
    }
    ...
    public function edit(string $nik_kk)
    {
        ...
        return view('ketua.manage.kk.editKK', compact('kartukeluarga', 'breadcrumb'));
    }
    ...
    return redirect()->route('ketua.kartukeluarga')->with('success', 'Kartu Keluarga telah diupdate');
}
    ...
    public function destroy(string $nik_kk)
    {
        ...
        return redirect()->route('ketua.kartukeluarga')->with('success', 'Kartu Keluarga telah didelete');
